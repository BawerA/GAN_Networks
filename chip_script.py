...
for myFile in files:
    ...
    while t < numberOfChips:
        ...
        #print("Chipped class: ", chipped_classes[t])
        #print("Chipped box:", chipped_box[t])
        t += 1
        per += 1
...
#print("numpy array: ", npchipped)
print("\n\n")
print("X_data.append numpy array:  ", np.array(X_data).shape)
print("\nThis is good^^^\n")

npchipped2 = np.array(X_data)  #  nchipped2 is the numpy array, I use it down below 
print("\nChipping images complete sir. \n")